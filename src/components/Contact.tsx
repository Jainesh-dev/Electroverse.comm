  ...
  return (
    <footer className="w-full bg-black text-white py-16 border-t border-white/10 font-sans relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col xl:flex-row gap-16 xl:gap-24 items-center xl:items-start justify-between">
          ...
          <div className="flex flex-col gap-6 max-w-xs text-center xl:text-left">
            ...
            <a
              ...
              className="inline-flex mx-auto xl:mx-0 items-center gap-2 px-5 py-2 rounded-full border border-purple-500/60 bg-white/5 hover:bg-purple-500/10 text-xs uppercase tracking-wide transition"
            >
        ...
        {/* Bottom Bar */}
        <div className="mt-20 pt-8 border-t border-white/10 flex flex-col md:flex-row gap-4 justify-between items-center text-xs text-gray-500 font-mono text-center">
